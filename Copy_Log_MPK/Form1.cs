...
namespace Copy_Log_MPK
{
    public partial class Copy_Log_MPK : Form
    {
        ...
        public Copy_Log_MPK(string number_ops)
        {         
            InitializeComponent();
            textBox4.Text = number_ops;
        }
      async private void button2_Click(object sender, EventArgs e)
        {
            await Task.Run(() => CopyLogMPK());
        }
        private void CopyLogMPK()
        {
            try
            {
                //string[] path_mass_configuration = new string[9]
                //{ @"\c$\ProgramData\RussianPost\nsi02\data\f130article-2021-10-01.json",
                //  @"\c$\ProgramData\RussianPost\nsi02\data\f130articletype-2021-10-01.json",
                //  @"\c$\ProgramData\RussianPost\nsi02\data\f130attributes-2021-10-01.json",
                //  @"\c$\ProgramData\RussianPost\nsi02\data\f130easops_map-2021-10-01.json",
                //  @"\c$\ProgramData\RussianPost\nsi02\data\f130easops_oper-2021-10-01.json",
                //  @"\c$\ProgramData\RussianPost\nsi02\data\f130mfk_sql-2021-10-01.json",
                //  @"\c$\ProgramData\RussianPost\nsi02\data\f130skdn-2021-10-01.json",
                //  @"\c$\ProgramData\RussianPost\nsi02\data\f130skdncommon-2021-10-01.json",
                //  @"\c$\ProgramData\RussianPost\nsi02\data\f130uploadsettings-2021-10-01.json"};
                int Count = 10000;
                            ...
                            if (p1.Length > 6 && p1[2] == y)
                            {
                                ...
                                else
                                {
                                    ...
                                    else
                                    {
                                        ...
                                        string path_configuration_copy_1 = @"D:\MPK_LOG\File_From_ip-" + p1 + " " + NewDateFormat + @"\Конфигурация ОПС " + p1 + @"\f130article-2021-12-01.json";
                                        string path_configuration_copy_2 = @"D:\MPK_LOG\File_From_ip-" + p1 + " " + NewDateFormat + @"\Конфигурация ОПС " + p1 + @"\f130articletype-2021-12-01.json";
                                        string path_configuration_copy_3 = @"D:\MPK_LOG\File_From_ip-" + p1 + " " + NewDateFormat + @"\Конфигурация ОПС " + p1 + @"\f130attributes-2021-12-01.json";
                                        string path_configuration_copy_4 = @"D:\MPK_LOG\File_From_ip-" + p1 + " " + NewDateFormat + @"\Конфигурация ОПС " + p1 + @"\f130easops_map-2021-12-01.json";
                                        string path_configuration_copy_5 = @"D:\MPK_LOG\File_From_ip-" + p1 + " " + NewDateFormat + @"\Конфигурация ОПС " + p1 + @"\f130easops_oper-2021-12-01.json";
                                        string path_configuration_copy_6 = @"D:\MPK_LOG\File_From_ip-" + p1 + " " + NewDateFormat + @"\Конфигурация ОПС " + p1 + @"\f130mfk_sql-2021-12-01.json";
                                        string path_configuration_copy_7 = @"D:\MPK_LOG\File_From_ip-" + p1 + " " + NewDateFormat + @"\Конфигурация ОПС " + p1 + @"\f130skdn-2021-12-01.json";
                                        string path_configuration_copy_8 = @"D:\MPK_LOG\File_From_ip-" + p1 + " " + NewDateFormat + @"\Конфигурация ОПС " + p1 + @"\f130skdncommon-2021-12-01.json";
                                        string path_configuration_copy_9 = @"D:\MPK_LOG\File_From_ip-" + p1 + " " + NewDateFormat + @"\Конфигурация ОПС " + p1 + @"\f130settings-2021-12-01.json";
                ...
                if (p1.Length == 6)
                {
                    ...
                    else
                    {
                        ...
                        else
                        {
                            ...
                            string path_configuration_copy_1 = @"D:\MPK_LOG\File_From_ops-" + p1 + " " + NewDateFormat + @"\Конфигурация ОПС " + p1 + @"\f130article-2021-12-01.json";
                            string path_configuration_copy_2 = @"D:\MPK_LOG\File_From_ops-" + p1 + " " + NewDateFormat + @"\Конфигурация ОПС " + p1 + @"\f130articletype-2021-12-01.json";
                            string path_configuration_copy_3 = @"D:\MPK_LOG\File_From_ops-" + p1 + " " + NewDateFormat + @"\Конфигурация ОПС " + p1 + @"\f130attributes-2021-12-01.json";
                            string path_configuration_copy_4 = @"D:\MPK_LOG\File_From_ops-" + p1 + " " + NewDateFormat + @"\Конфигурация ОПС " + p1 + @"\f130easops_map-2021-12-01.json";
                            string path_configuration_copy_5 = @"D:\MPK_LOG\File_From_ops-" + p1 + " " + NewDateFormat + @"\Конфигурация ОПС " + p1 + @"\f130easops_oper-2021-12-01.json";
                            string path_configuration_copy_6 = @"D:\MPK_LOG\File_From_ops-" + p1 + " " + NewDateFormat + @"\Конфигурация ОПС " + p1 + @"\f130mfk_sql-2021-12-01.json";
                            string path_configuration_copy_7 = @"D:\MPK_LOG\File_From_ops-" + p1 + " " + NewDateFormat + @"\Конфигурация ОПС " + p1 + @"\f130skdn-2021-12-01.json";
                            string path_configuration_copy_8 = @"D:\MPK_LOG\File_From_ops-" + p1 + " " + NewDateFormat + @"\Конфигурация ОПС " + p1 + @"\f130skdncommon-2021-12-01.json";
                            string path_configuration_copy_9 = @"D:\MPK_LOG\File_From_ops-" + p1 + " " + NewDateFormat + @"\Конфигурация ОПС " + p1 + @"\f130settings-2021-12-01.json";
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            ...
            textBox5.Text = EAS_DateTime_Now;
        }
    }
}
